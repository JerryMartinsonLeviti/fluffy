...
class VacvTable extends SupabaseTable<VacvRow> {
  @override
  String get tableName => 'vacv';

  @override
  VacvRow createRow(Map<String, dynamic> data) => VacvRow(data);
}

class VacvRow extends SupabaseDataRow {
  VacvRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VacvTable();
  ...
  int? get pKParentVendor => getField<int>('PK_ParentVendor');
  set pKParentVendor(int? value) => setField<int>('PK_ParentVendor', value);
}
