...
class _AddressWidgetState extends State<AddressWidget> {
  ...
  void initState() {
    ...
    _model.street1TFTextController ??=
        TextEditingController(text: widget.street1);
    _model.street1TFFocusNode ??= FocusNode();

    _model.street2TFTextController ??=
        TextEditingController(text: widget.street2);
    _model.street2TFFocusNode ??= FocusNode();

    _model.cityTextController ??= TextEditingController(text: widget.city);
    _model.cityFocusNode ??= FocusNode();

    _model.stateTextController ??= TextEditingController(text: widget.state);
    _model.stateFocusNode ??= FocusNode();

    _model.zipTextController ??= TextEditingController(text: widget.zip);
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  8.0, 0.0, 8.0, 0.0),
                              child: TextFormField(
                                controller: _model.street1TFTextController,
                                focusNode: _model.street1TFFocusNode,
                                autofocus: true,
                                obscureText: false,
                                ...
                                validator: _model
                                    .street1TFTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  8.0, 0.0, 8.0, 0.0),
                              child: TextFormField(
                                controller: _model.street2TFTextController,
                                focusNode: _model.street2TFFocusNode,
                                autofocus: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Street2',
                                ...
                                validator: _model
                                    .street2TFTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Padding(
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    await AddressesTable().update(
                                      data: {
                                        'streetName1':
                                            _model.street1TFTextController.text,
                                        'regionCode':
                                            _model.stateTextController.text,
                                        'postalCode':
                                            _model.zipTextController.text,
                                        'streetName2':
                                            _model.street2TFTextController.text,
