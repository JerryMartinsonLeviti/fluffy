...
class DividerColumnWidget extends StatefulWidget {
  const DividerColumnWidget({super.key});

  @override
  State<DividerColumnWidget> createState() => _DividerColumnWidgetState();
}

class _DividerColumnWidgetState extends State<DividerColumnWidget> {
  late DividerColumnModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DividerColumnModel());
