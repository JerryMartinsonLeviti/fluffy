    ...
    return FutureBuilder<List<AssetCollectionsViewRow>>(
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: FutureBuilder<List<CartFunctionSpaceRow>>(
            ...
            builder: (context, snapshot) {
              ...
              List<CartFunctionSpaceRow> fSCartDBCartFunctionSpaceRowList =
                  snapshot.data!;
              return Container(
                decoration: BoxDecoration(),
                child: Stack(
                        ...
                        children: [
                          ...
                          if (widget.functionSpaceRow
                            ...
                            Text(
                              valueOrDefault<String>(
                                widget
                                    .functionSpaceRow?.functionSpaceDescription,
                                'no_desc',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                              ...
                              Align(
                                ...
                                child: Wrap(
                                  ...
                                  children: [
                                    if (widget.functionSpaceRow
                                      ...
                                      Text(
                                        'Seated:${valueOrDefault<String>(
                                          widget
                                              .functionSpaceRow?.seatingCapacity
                                              ?.toString(),
                                          '0',
                                        )}',
                                        style: FlutterFlowTheme.of(context)
                                    ...
                                    if (widget
                                            .functionSpaceRow?.squareFootage !=
                                        null)
                                      Text(
                          ...
                          if (widget.functionSpaceRow?.foodAndBevApplies ??
                              true)
                            Text(
                          ...
                          Row(
                            ...
                            children: [
                              if (!(fSCartDBCartFunctionSpaceRowList
                                  .isNotEmpty))
                                FFButtonWidget(
                                  onPressed: () async {
                              ...
                              if (fSCartDBCartFunctionSpaceRowList.isNotEmpty)
                                FFButtonWidget(
                                  onPressed: () async {
                                    await widget.onSelectChange?.call(
                                      false,
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        await FunctionSpacesTable().update(
                                          data: {
                                            'function_space_name': _model
                                                .fSNameTextController.text,
                                            'function_space_description': _model
                                                .fSDescTextController.text,
                                            'rental_fee_in_cents':
                                                functions.stringToCents(_model
                                                    .rentalFeeTextController
                                                    .text),
                                            'rental_fee_applies':
                                                _model.rentalValue,
