...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'VendorRTB_ConfirmationSentCopy',
          path: '/vendorRTBConfirmationSentCopy',
          builder: (context, params) => VendorRTBConfirmationSentCopyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'LiaisonTaskListCopy',
          path: '/liaisonTaskListCopy',
          builder: (context, params) => LiaisonTaskListCopyWidget(),
        ),
        FFRoute(
          name: 'LiaisonTaskList_Detail',
          path: '/liaisonTaskListDetail',
          builder: (context, params) => LiaisonTaskListDetailWidget(),
        ),
        FFRoute(
          name: 'Liaison_Task',
          path: '/liaisonTask',
          builder: (context, params) => LiaisonTaskWidget(),
        ),
        FFRoute(
          name: 'LiaisonTaskPage-DetailsCopy',
          path: '/liaisonTaskPageDetailsCopy',
          builder: (context, params) => LiaisonTaskPageDetailsCopyWidget(),
        ),
        FFRoute(
