...
class _Settings2EditProfileWidgetState
  ...
  void initState() {
    ...
    _model.textController2 ??= TextEditingController(text: 'Company Name');
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(text: 'Title');
    _model.textFieldFocusNode3 ??= FocusNode();

    _model.textController4 ??= TextEditingController(text: 'Work Email');
    _model.textFieldFocusNode4 ??= FocusNode();

    _model.textController5 ??= TextEditingController(text: 'Telephone Number');
