...
class LiaisonDashboardWidget extends StatefulWidget {
  const LiaisonDashboardWidget({super.key});

  @override
  State<LiaisonDashboardWidget> createState() => _LiaisonDashboardWidgetState();
}

class _LiaisonDashboardWidgetState extends State<LiaisonDashboardWidget>
    with TickerProviderStateMixin {
  late LiaisonDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LiaisonDashboardModel());
