...
import 'listing_page_edit_mode_model.dart';
export 'listing_page_edit_mode_model.dart';

class ListingPageEditModeWidget extends StatefulWidget {
  const ListingPageEditModeWidget({super.key});

  @override
  State<ListingPageEditModeWidget> createState() =>
      _ListingPageEditModeWidgetState();
}

class _ListingPageEditModeWidgetState extends State<ListingPageEditModeWidget> {
  late ListingPageEditModeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListingPageEditModeModel());
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      28.0, 10.0, 0.0, 15.0),
                                              child: Text(
                                                'Ci Siamo, Midtown New York City',
                              ...
                              Column(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/teams/bjcNcUcJFzipGWqoNchx/assets/l173dyfxd91j/Image_5-18-24_at_3.10_PM.jpeg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              Column(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/teams/bjcNcUcJFzipGWqoNchx/assets/rg2kddupxuw6/Image_5-18-24_at_3.10_PM_(1).jpeg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              Column(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/teams/bjcNcUcJFzipGWqoNchx/assets/b7ya8q618hsn/Image_5-18-24_at_3.09_PM_(1).jpeg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              Column(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/teams/bjcNcUcJFzipGWqoNchx/assets/b3chjuxzeolk/Image_5-18-24_at_3.11_PM_(1).jpeg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                ...
                Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: wrapWithModel(
                        model: _model.productDetailPageOptionsLanguageModel,
                        updateCallback: () => setState(() {}),
                        child: ProductDetailPageOptionsLanguageWidget(),
                      ),
                    ),
                  ),
                ),
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '1 Hour of Hors d\'Oeuvres Service',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                        ...
                                        children: [
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 10.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Harvest Table: Chef\'s Selection of Cheeses, Cured Meats, Crudite',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                'Dolci: Chef\'s Selection of Sweets',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 30.0, 0.0, 0.0),
                                              child: Text(
                                                'Selections are subject to seasonal change based on market availability',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 10.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Unlimited beer and non-alcoholic beverages with the exception of bottled water',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 20.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Selection of sparkling‚ red‚ and white wines including Prosecco‚ Pinot Grigio‚ and Giuliana\nVicini Montepulciano d\'Abruzzo',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 20.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Selection of sparkling‚ red‚ and white wines including Champagne‚ Pra Soave Classico‚\nand Scarpetta Cabernet Franc',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 20.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Selection of sparkling‚ red‚ and white wines including Goutorbe Bouillot Rose Champagne‚\nFelsina Chardonnay‚ Montefalco Rosso Umbria',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
