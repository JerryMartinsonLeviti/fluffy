...
import 'cart_summary_component_copy_model.dart';
export 'cart_summary_component_copy_model.dart';

class CartSummaryComponentCopyWidget extends StatefulWidget {
  const CartSummaryComponentCopyWidget({
    super.key,
  ...
  @override
  State<CartSummaryComponentCopyWidget> createState() =>
      _CartSummaryComponentCopyWidgetState();
}

class _CartSummaryComponentCopyWidgetState
    extends State<CartSummaryComponentCopyWidget> {
  late CartSummaryComponentCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartSummaryComponentCopyModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  _model.plannerRows2 = await PlannersTable().queryRows(
                    queryFn: (q) => q.eq(
                      'PK_Planners',
                      FFAppState().PKVendors,
                    ),
                  );
                  _model.userInfoRows2 = await UserInfosTable().queryRows(
                    queryFn: (q) => q.eq(
                      'FK_Planner',
                      FFAppState().PKPlanner,
                    ),
