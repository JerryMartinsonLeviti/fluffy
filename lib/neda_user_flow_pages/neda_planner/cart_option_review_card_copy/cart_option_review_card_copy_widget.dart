...
import 'cart_option_review_card_copy_model.dart';
export 'cart_option_review_card_copy_model.dart';

class CartOptionReviewCardCopyWidget extends StatefulWidget {
  const CartOptionReviewCardCopyWidget({
    super.key,
  ...
  @override
  State<CartOptionReviewCardCopyWidget> createState() =>
      _CartOptionReviewCardCopyWidgetState();
}

class _CartOptionReviewCardCopyWidgetState
    extends State<CartOptionReviewCardCopyWidget> {
  late CartOptionReviewCardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartOptionReviewCardCopyModel());
