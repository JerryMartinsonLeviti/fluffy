...
import 'event_cart_review_page_copy_model.dart';
export 'event_cart_review_page_copy_model.dart';

class EventCartReviewPageCopyWidget extends StatefulWidget {
  const EventCartReviewPageCopyWidget({
    super.key,
  ...
  @override
  State<EventCartReviewPageCopyWidget> createState() =>
      _EventCartReviewPageCopyWidgetState();
}

class _EventCartReviewPageCopyWidgetState
    extends State<EventCartReviewPageCopyWidget> {
  late EventCartReviewPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventCartReviewPageCopyModel());
                                      ...
                                      return Wrap(
                                        ...
                                        children: List.generate(
                                          ...
                                          return CartOptionReviewCardWidget(
                                            key: Key(
                                                'Keywcl_${cartIndexIndex}_of_${cartIndex.length}'),
