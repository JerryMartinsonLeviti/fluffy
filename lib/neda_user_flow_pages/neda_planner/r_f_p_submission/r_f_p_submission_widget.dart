...
import 'r_f_p_submission_model.dart';
export 'r_f_p_submission_model.dart';

class RFPSubmissionWidget extends StatefulWidget {
  const RFPSubmissionWidget({
    super.key,
  ...
  @override
  State<RFPSubmissionWidget> createState() => _RFPSubmissionWidgetState();
}

class _RFPSubmissionWidgetState extends State<RFPSubmissionWidget> {
  late RFPSubmissionModel _model;
