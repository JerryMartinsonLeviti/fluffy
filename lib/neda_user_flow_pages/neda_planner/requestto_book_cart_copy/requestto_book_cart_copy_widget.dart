...
import 'requestto_book_cart_copy_model.dart';
export 'requestto_book_cart_copy_model.dart';

class RequesttoBookCartCopyWidget extends StatefulWidget {
  const RequesttoBookCartCopyWidget({
    super.key,
  ...
  @override
  State<RequesttoBookCartCopyWidget> createState() =>
      _RequesttoBookCartCopyWidgetState();
}

class _RequesttoBookCartCopyWidgetState
    extends State<RequesttoBookCartCopyWidget> {
  late RequesttoBookCartCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequesttoBookCartCopyModel());
