...
import 'planner_m_a_i_n_dash_copy_model.dart';
export 'planner_m_a_i_n_dash_copy_model.dart';

class PlannerMAINDashCopyWidget extends StatefulWidget {
  const PlannerMAINDashCopyWidget({super.key});

  @override
  State<PlannerMAINDashCopyWidget> createState() =>
      _PlannerMAINDashCopyWidgetState();
}

class _PlannerMAINDashCopyWidgetState extends State<PlannerMAINDashCopyWidget>
    with TickerProviderStateMixin {
  late PlannerMAINDashCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlannerMAINDashCopyModel());
                      ...
                      child: Wrap(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('ManageEvents_MyEvents');
                            },
                            child: Container(
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 5.0, 0.0, 0.0),
                                          child: Text(
                                            'Check Status, Update Requests for Proposal & Requests to Book',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
