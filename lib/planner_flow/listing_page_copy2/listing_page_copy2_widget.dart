...
import 'listing_page_copy2_model.dart';
export 'listing_page_copy2_model.dart';

class ListingPageCopy2Widget extends StatefulWidget {
  const ListingPageCopy2Widget({super.key});

  @override
  State<ListingPageCopy2Widget> createState() => _ListingPageCopy2WidgetState();
}

class _ListingPageCopy2WidgetState extends State<ListingPageCopy2Widget> {
  late ListingPageCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListingPageCopy2Model());
