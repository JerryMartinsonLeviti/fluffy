...
class PaymentModalComponentWidget extends StatefulWidget {
  const PaymentModalComponentWidget({super.key});

  @override
  State<PaymentModalComponentWidget> createState() =>
      _PaymentModalComponentWidgetState();
}

class _PaymentModalComponentWidgetState
    extends State<PaymentModalComponentWidget> {
  late PaymentModalComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentModalComponentModel());
