...
class PlannerSideNavBarWidget extends StatefulWidget {
  const PlannerSideNavBarWidget({super.key});

  @override
  State<PlannerSideNavBarWidget> createState() =>
      _PlannerSideNavBarWidgetState();
}

class _PlannerSideNavBarWidgetState extends State<PlannerSideNavBarWidget> {
  late PlannerSideNavBarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlannerSideNavBarModel());
