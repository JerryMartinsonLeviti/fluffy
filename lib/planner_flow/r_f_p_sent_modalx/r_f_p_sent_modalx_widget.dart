...
import 'r_f_p_sent_modalx_model.dart';
export 'r_f_p_sent_modalx_model.dart';

class RFPSentModalxWidget extends StatefulWidget {
  const RFPSentModalxWidget({super.key});

  @override
  State<RFPSentModalxWidget> createState() => _RFPSentModalxWidgetState();
}

class _RFPSentModalxWidgetState extends State<RFPSentModalxWidget> {
  late RFPSentModalxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RFPSentModalxModel());
