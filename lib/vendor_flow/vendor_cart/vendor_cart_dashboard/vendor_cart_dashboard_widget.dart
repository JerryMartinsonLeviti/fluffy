...
class VendorCartDashboardWidget extends StatefulWidget {
  const VendorCartDashboardWidget({super.key});

  @override
  State<VendorCartDashboardWidget> createState() =>
      _VendorCartDashboardWidgetState();
}

class _VendorCartDashboardWidgetState extends State<VendorCartDashboardWidget> {
  late VendorCartDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VendorCartDashboardModel());
                                                ...
                                                return Column(
                                                  ...
                                                  children: List.generate(
                                                    ...
                                                    return VendorCartLineComponentWidget(
                                                      key: Key(
                                                          'Keyx5s_${eventIndexIndex}_of_${eventIndex.length}'),
