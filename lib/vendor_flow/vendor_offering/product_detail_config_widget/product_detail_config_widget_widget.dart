...
class ProductDetailConfigWidgetWidget extends StatefulWidget {
  const ProductDetailConfigWidgetWidget({super.key});

  @override
  State<ProductDetailConfigWidgetWidget> createState() =>
      _ProductDetailConfigWidgetWidgetState();
}

class _ProductDetailConfigWidgetWidgetState
    extends State<ProductDetailConfigWidgetWidget> {
  late ProductDetailConfigWidgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductDetailConfigWidgetModel());

    _model.internalNameTextFieldTextController ??= TextEditingController();
    _model.internalNameTextFieldFocusNode ??= FocusNode();

    _model.displayNameTextFieldTextController ??= TextEditingController();
    _model.displayNameTextFieldFocusNode ??= FocusNode();

    _model.priceTextFieldTextController ??= TextEditingController(text: '100');
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      focusNode: _model.internalNameTextFieldFocusNode,
                      autofocus: true,
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'InternalName',
                        labelStyle:
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model.uoMDropDownValueController ??=
                                FormFieldController<String>(null),
                            options: UnitOfMeasure.values
                                .map((e) => e.name)
                                .toList(),
                            onChanged: (val) =>
                                setState(() => _model.uoMDropDownValue = val),
                            width: 300.0,
                            height: 56.0,
                            textStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
